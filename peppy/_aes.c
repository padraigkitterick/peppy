...
static char *Module_docstring =
 ...
 "Python-wrapped AES encryption routines.\n"
 "Padraig Kitterick\nDepartment of Psychology\nUniversity of York, UK"
;

/* --- test --------------------------------------------------------------------- */
static char *Func_test_docstring =
 "test() -> int\n\n"
 "Returns zero."
;

extern "C" PyObject* test(PyObject *self, PyObject *args) {

	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	
	return Py_BuildValue("i", nUsed);
}

/* --- method table and initialisation ------------------------------------------- */
static PyMethodDef _aesMethods[] = {
    {"test",  (PyCFunction)test, METH_VARARGS, Func_test_docstring},
    {NULL, NULL, 0, NULL}
};

extern "C" void init_aes(void)
{
    (void) Py_InitModule3("_aes", _aesMethods, Module_docstring);
}
